...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-12-2018 a las 19:24:42
...
(4, 'Luis Bustos', 3819485, 15523654);
...
ALTER TABLE `matricula`
  ...
  ADD KEY `matricula_ibfk_2` (`id_curso`);
...
--
ALTER TABLE `matricula`
  ADD CONSTRAINT `matricula_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `matricula_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
